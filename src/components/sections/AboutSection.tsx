      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/5] rounded-2xl border border-eucalyptus overflow-hidden bg-gradient-to-br from-midnight/[0.04] to-emerald/[0.04] flex items-center justify-center">
              <div className="text-center p-8">
                <div className="w-20 h-20 rounded-full bg-emerald/[0.08] flex items-center justify-center mx-auto mb-4">
                  <Heart className="w-8 h-8 text-emerald" />
                </div>
                <p className="font-serif text-charcoal/70 text-lg italic">Our Founding Team</p>
                <p className="text-muted-foreground text-sm mt-2 font-sans">Dedicated to transforming biology education</p>
              </div>
            </div>
            {/* Decorative offset */}
            <div className="absolute -bottom-3 -right-3 w-full h-full border border-eucalyptus/60 rounded-2xl -z-10" />
          </div>

          {/* Content */}
          <div>
            <span className="text-emerald font-sans text-[10px] tracking-[0.25em] uppercase font-medium">About Us</span>
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item.title} className="flex gap-4">
                  <div className="w-10 h-10 rounded-lg bg-emerald/[0.08] flex items-center justify-center flex-shrink-0">
